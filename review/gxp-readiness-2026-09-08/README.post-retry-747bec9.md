...
[assessment.md](assessment.md) is the current GLP/GCP readiness assessment, updated for the retry-record fix in the working tree based on `a6ec93a2bba5ca54944a6d495fce5315e9154826`. Four of the six original observed findings are resolved locally; two remain open. This is not a compliance score or deployment approval.
